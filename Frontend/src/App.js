      ...
      {isClicked && (
        ...
        >
          ...
          <div className="m-3 text-lg">
            ...
            <div className=" max-w-full">{clickData.Project_Technologies}</div>
          </div>
          <div className="m-3 text-lg">
            <div className=" font-semibold flex max-w-max align-middle text-xl">
              <img className=" pe-2 h-5 m-auto" src={icon} />
          ...
          BackendData.filter((val) => {
            ...
            return (
              <div className="  card p-2 rounded">
                <div key={val._id} className=" p-2 " onClick={(e) => view(val)}>
                  <div className="py-2">
                  ...
                  <div className="py-2">
                    ...
                    <div>
                      <ReadMore>{val.Project_Technologies}</ReadMore>
                    </div>
                  </div>
                  <div className=" py-2">
                    <div className=" text-slate-400 text-sm">
                    ...
                    <div>
                      <ReadMore>{val.Technical_Skillset_Frontend}</ReadMore>
                    </div>
                  </div>
                  <div className="py-2">
                    <div className=" text-slate-400 text-sm">
                    ...
                    <div>
                      <ReadMore>{val.Technical_Skillset_Backend}</ReadMore>
                    </div>
                  </div>
                  <div className="py-2">
                    <div className=" text-slate-400 text-sm">
                    ...
                    <div>
                      <ReadMore>{val.Other_Information_Availability}</ReadMore>
                    </div>
                  </div>
                </div>
              </div>
